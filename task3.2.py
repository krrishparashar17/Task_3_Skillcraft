...
if __name__ == "__main__":
    # Define directories
    TRAIN_DIR = "C:/Users/krris/Downloads/dogs-vs-cats/train/train"
    TEST_DIR = "C:/Users/krris/Downloads/dogs-vs-cats/test1/test1"
    
    # Initialize classifier
    classifier = CatDogSVMClassifier(TRAIN_DIR, TEST_DIR, img_size=(64, 64))
    
    # Load and prepare training data
    X_train, y_train = classifier.load_training_data(sample_size=5000)  # Reduced for faster training
